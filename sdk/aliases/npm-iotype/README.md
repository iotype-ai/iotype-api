...
This is an **alias package**. It re-exports [`@iotype-ai/sdk`](https://www.npmjs.com/package/@iotype-ai/sdk),
the official JavaScript/TypeScript SDK for the [iotype API](https://iotype.com/api-service).

```bash
npm install iotype          # works — pulls in @iotype-ai/sdk
npm install @iotype-ai/sdk  # the canonical name
```
